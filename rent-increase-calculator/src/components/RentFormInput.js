        ...
        <div className="ml-auto md:ml-0 md:w-1/4">
          <div className="relative text-gray-700">
            <input
              ...
              name={id}
              className={
                "w-full pl-8 rounded border border-gray-300 bg-stone-50 p-3 shadow shadow-gray-100  appearance-none outline-none text-neutral-800 " +
